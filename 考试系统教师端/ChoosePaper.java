import InquireScore.BarChartDemo;
import InquireScore.DbConnection;
import InquireScore.SelectF;
...
public class ChoosePaper extends JPanel {
    ...
    private void init() {
        String headName[] = { "编号", "试卷","难度", "截止时间", "考试时长","操作" };
        //查询答题结果表显示数据
        ...
        try {
            ...
            while (rs.next()){
                name.add(rs.getString("examname"));
                Object tmp[] = {
                        rs.getInt("examid"),
                        ...
                        new MyButton("进入",rs.getInt("examid"))
                };
                data.add(tmp);
            }
        ...
        Object object[][] = new Object[data.size()][5];
       ...
       /* Object obj[][] = {
        ...
        table.setDefaultRenderer(MyButton.class, new ComboBoxCellRenderer3());
...
class ComboBoxCellRenderer3 implements TableCellRenderer {
